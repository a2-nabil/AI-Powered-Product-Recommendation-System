 ...
 * Text Domain: AI-Powered-Product-Recommendation-System
...
class AI_Product_Recommender
{
            ...
            <div id="nxt_open" class="nxtChat-toggle-icon">
                <svg width="50px" height="50px" viewBox="0 0 2 2" xmlns="http://www.w3.org/2000/svg">
                    <g fill="none" fill-rule="evenodd">
                        <path cx="16" cy="16" r="16" fill="var(--primary-color)"
                            d="M2 1A1 1 0 0 1 1 2A1 1 0 0 1 0 1A1 1 0 0 1 2 1z" />
                        <path fill="#FFF"
    ...
    public function woocommerce_missing_notice()
    {
        ...
        <div class="notice notice-error">
            <p><?php echo esc_html_e('AI Product Recommender requires WooCommerce to be installed and active.', 'AI-Powered-Product-Recommendation-System'); ?>
            </p>
        </div>
        <?php
    }
